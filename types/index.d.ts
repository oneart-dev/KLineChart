...
export type IndicatorFigureStyle = Partial<Omit<SmoothLineStyle, "style">> & Partial<Omit<RectStyle, "style">> & Partial<RectTextStyle> & Partial<{
	style: LineType[keyof LineType] | PolygonType[keyof PolygonType];
}> & {
	[key: string]: any;
};
export type IndicatorFigureAttrs = Partial<ArcAttrs> & Partial<LineStyle> & Partial<RectAttrs> & Partial<TextAttrs> & {
	[key: string]: any;
};
...
declare function checkCoordinateOnWick(coordinate: Coordinate, line: WickAttrs): boolean;
declare function drawWick(ctx: CanvasRenderingContext2D, attrs: WickAttrs, styles: Partial<LineStyle>): void;
...
export declare const utils: {
	...
	checkCoordinateOnWick: typeof checkCoordinateOnWick;
