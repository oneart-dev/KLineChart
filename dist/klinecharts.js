...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 9.4.0', 'border-radius:4px;border:dashed 1px #1677FF;line-height:70px;padding:0 20px;margin:16px 0;font-size:14px;color:#1677FF;', '', '', '', '');
}
...
var TimeScaleStore = /** @class */ (function () {
    function TimeScaleStore(chartStore) {
         ...
         */
        this._loadMoreForwardCallback = null;
        /**
    ...
    TimeScaleStore.prototype.adjustVisibleRange = function () {
        ...
        if (from === 0 && this._more && !this._loading && this._loadMoreCallback !== null) {
            ...
            this._loading = true;
            var lastData = dataList[dataCount - 1];
            this._loadMoreForwardCallback((_b = lastData === null || lastData === void 0 ? void 0 : lastData.timestamp) !== null && _b !== void 0 ? _b : null);
        }
    };
    ...
    TimeScaleStore.prototype.setLoadMoreForwardCallback = function (callback) {
            ...
            tooltipData = [
                {
                    ...
                    value: {
                        text: formatThousands(customApi.formatBigNumber(formatPrecision((_c = current.volume) !== null && _c !== void 0 ? _c : tooltipStyles.defaultValue, volumePrecision)), thousandsSeparator),
                        color: textColor
                    }
                }
            ];
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.loadMoreForward = function (cb) {
